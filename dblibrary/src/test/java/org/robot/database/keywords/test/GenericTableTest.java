...
public class GenericTableTest {
	...
	public void setUp() throws Exception {
		...
		dbKeywords.connectToDatabase(
				...
				"jdbc:teradata://teradev/DATABASE=" + "baseproductglentz" + ",CHARSET=UTF8",
	...
	public void testReturnGeneratedJobInstanceId() throws Exception {
		URL url = this.getClass().getResource("/ProductVariationMCDS.csv");
		assertNotNull(url);
		String filepath = new File(url.toURI()).getAbsolutePath();
		dbKeywords.importTableFromFile("ProductVariationMCDS", filepath);
	}
}
